        ...
        <Container className="relative z-10">
          ...
          >
            ...
            >
              ...
              <span className="text-sm">Expertise professionnelle</span>
            </motion.div>
          ...
          >
            {advantages.map((item) => (
              <motion.div
                ...
                className="group bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 text-center border border-gray-100"
              >
                <div className="w-16 h-16 bg-gradient-to-br from-[var(--color-primary)]/20 to-[var(--color-primary)]/5 rounded-xl flex items-center justify-center mx-auto mb-6 text-[var(--color-primary)] group-hover:scale-110 transition-transform">
                  {item.icon}
                </div>
                <h3
