...
const debarrasTypes = [
  ...
  },
  {
    ...
    description:
      "Intervention spécialisée pour les logements touchés par le syndrome de Diogène. Débarras complet, nettoyage extrême et désinfection. Discrétion totale.",
    href: "/debarras/diogene",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8">
